...
builder.Services
    ...
    {
        // Without this, the handler renames short claims like "sub" to long ClaimTypes.* URIs,
        // so HttpContextUserProvider's FindFirst("sub") would find nothing even with a valid token.
